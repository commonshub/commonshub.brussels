...
const rooms = [
  {
    ...
    capacity: 80,
    description:
      "Perfect for events, big circles, panels, fishbowls, facilitation...",
    pricePerHour: 100,
    tokensPerHour: 3,
  ...
  },
  {
    ...
    name: "Playroom",
    capacity: 10,
    description: "Perfect for a good kicker game ⚽️",
    pricePerHour: 25,
    tokensPerHour: 1,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            Bring your community together in our versatile spaces. Perfect for
            events, workshops, meetings, and gatherings of all kinds.
          </p>
          <p className="mt-2 text-sm text-muted-foreground max-w-2xl mx-auto">
            Members enjoy a 30% discount and priority booking. They can also use
            tokens earned from community contributions.
          </p>
        </div>
